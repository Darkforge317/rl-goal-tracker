...
- Run the test within [GoalTrackerPluginTest](src/test/java/com/darkforge317/goaltracker/GoalTrackerPluginTest.java)
...
- Update the commit hash to the relevant hash on [master](https://github.com/Darkforge317/rl-goal-tracker/commits/master/)